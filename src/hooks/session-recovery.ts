...
import type { StopInput, TranscriptMessage, TranscriptContent } from "../lib/types.js";

type ErrorType = "context_overflow" | "repeated_tool_failures" | "build_failure" | "test_failure" | "unknown";
...
function detectErrorType(text: string): ErrorType | null {
...
function buildRecoveryAction(errorType: ErrorType, circuitBreakerSummary: string): string {
  switch (errorType) {
...
function extractRecentFiles(transcript: TranscriptMessage[]): string[] {
