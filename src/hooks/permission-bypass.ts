...
function isInternalStatePath(filePath: string): boolean {
...
function evaluatePermission(input: PermissionRequestInput): SmartDecision | null {
...
function evaluateTrustPermission(
